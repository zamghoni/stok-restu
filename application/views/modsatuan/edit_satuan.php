...
<head>
  ...
  <title>Satuan | Stok Bengkel Restu</title>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a class="nav-link" href="<?php echo base_url('Satuan')?>">Satuan Barang</a></li>
          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form role="form" action="<?php echo base_url('Satuan/edit/'.$satuan[0]->id_satuan)?>" method="post">
                      <div class="form-group">
                        <label>Kode Satuan *</label>
                        <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $satuan[0]->nm_satuan?>">
                        <p><?php echo form_error('kode'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>Nama Satuan *</label>
                        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $satuan[0]->deskripsi?>">
                        <p><?php echo form_error('nama'); ?></p>
                      </div>
                      <br>
                      <button type="submit" class="btn btn-primary">Simpan</button>
                      <a class="btn btn-secondary" href="<?php echo base_url('Satuan') ?>">Batal</a>
                    </form>
                </div>
              </div>
            </div>
