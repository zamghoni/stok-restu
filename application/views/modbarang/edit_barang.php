...
<head>
  ...
  <title>Barang | Stok Bengkel Restu</title>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a class="nav-link" href="<?php echo base_url('Barang')?>">Data Barang</a></li>
                </ul>
              </li>
              <?php
              }
          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form role="form" action="<?php echo base_url('Barang/edit/'.$barang[0]->id_barang)?>" method="post">
                      <div class="form-group">
                        <label>Kode Barang *</label>
                        <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $barang[0]->id_barang?>" readonly>
                        <p><?php echo form_error('kode'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>Nama Barang *</label>
                        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $barang[0]->nm_barang?>">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="satuan" id="satuan">
                          ...
                          ?>
                          <option value="<?php echo $row->id_satuan ?>" <?php echo $row->id_satuan == $barang[0]->id_satuan ? 'selected' : "" ;?>><?php echo $row->nm_satuan ; ?></option>
                          <?php } ?>
                        </select>
                        <p><?php echo form_error('satuan'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>Jenis *</label>
                        <select class="form-control" name="jenis" id="jenis">
                          ...
                          ?>
                          <option value="<?php echo $row->id_jenis ?>" <?php echo $row->id_jenis == $barang[0]->id_jenis ? 'selected' : "" ;?>><?php echo $row->nm_jenis ; ?></option>
                          <?php } ?>
                        </select>
                        <p><?php echo form_error('jenis'); ?></p>
                      </div>
                      <br>
                      <button type="submit" class="btn btn-primary">Simpan</button>
                      <a class="btn btn-secondary" href="<?php echo base_url('Barang') ?>">Batal</a>
                    </form>
                </div>
              </div>
            </div>
