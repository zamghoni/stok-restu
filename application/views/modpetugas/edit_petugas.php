          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form role="form" action="<?php echo base_url('Petugas/edit/'.$petugas[0]->userid)?>" method="post">
                      <div class="form-group">
                        <label>Username *</label>
                        <input type="text" class="form-control" id="username" name="username" value="<?php echo $petugas[0]->userid?>" readonly>
                        <p><?php echo form_error('username'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>Nama Petugas *</label>
                        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $petugas[0]->nm_petugas?>">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="level" id="level">
                          ...
                          <option value="Administrator" <?php echo ($petugas[0]->level == 'Administrator' ? 'selected' : ''); ?>>Administrator</option>
                        <option value="Staff" <?php echo ($petugas[0]->level == 'Staff' ? 'selected' : ''); ?>>Staff</option>
                          <option value="Manager" <?php echo ($petugas[0]->level == 'Manager' ? 'selected' : ''); ?>>Manager</option>
                        </select>
                        <p><?php echo form_error('level'); ?></p>
                      </div>
                      <br>
                      <button type="submit" class="btn btn-primary">Simpan</button>
                      <a class="btn btn-secondary" href="<?php echo base_url('Petugas') ?>">Batal</a>
                    </form>
                </div>
              </div>
            </div>
