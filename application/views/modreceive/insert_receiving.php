        ...
        <div class="main-content">
          <section class="section">
            ...
            <div class="section-body">
              ...
              <?php
              $no_transaksi = $data['id_brgmasuk'];
              $urutan = (int) substr($no_transaksi,-4);
              $urutan++;
              $no_transaksi=sprintf("%04s", $urutan);
              $kode="TRM-";
              ?>
              <div class="row">
                    ...
                    <div class="card-body">
                      <form role="form" action="<?php echo base_url('Receiving/insert')?>" method="post">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="kode" name="kode" value="<?=$kode.$no_transaksi?>" readonly>
