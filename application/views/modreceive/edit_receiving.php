      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Edit Receiving</h2>

            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form role="form" action="<?php echo base_url('Receiving/edit/'.$receiving[0]->id_brgmasuk)?>" method="post">
                      <div class="form-group">
                        <label>No. Transaksi *</label>
                        <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $receiving[0]->id_brgmasuk?>" readonly>
                        <p><?php echo form_error('kode'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>Tgl. Transaksi *</label>
                        <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?php echo $receiving[0]->tgl_masuk?>">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="supplier" id="supplier">
                          ...
                          ?>
                          <option value="<?php echo $row->id_supplier ?>" <?php echo $row->id_supplier == $receiving[0]->id_supplier ? 'selected' : "" ;?>><?php echo $row->nm_supplier ; ?></option>
                          <?php } ?>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="reference" name="reference" value="<?php echo $receiving[0]->reference?>">
                      </div>
                      <div class="form-group">
                        <label>Barang *</label>
                        <select class="form-control" name="barang" id="barang">
                          ...
                          ?>
                          <option value="<?php echo $row->id_barang ?>" <?php echo $row->id_barang == $receiving[0]->id_barang ? 'selected' : "" ;?>><?php echo $row->nm_barang ; ?></option>
                          <?php } ?>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="jumlah" name="jumlah" value="<?php echo $receiving[0]->jml_masuk?>">
