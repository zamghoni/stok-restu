      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title"><a class="btn btn-outline-primary btn-sm" href="<?php echo base_url('Receiving/insert')?>"><i class="fa fa-plus"> Add Data</i></a></h2>
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $i ?></td>
                             ...
                             <td>
                              <a href="<?php echo base_url('Receiving/edit/'.$data->id_brgmasuk);?>">
                                <button type="button" class="btn btn-outline-success btn-rounded btn-sm"><i class="fa fa-edit"> Edit</i></button>
                              </a>
                              <a href="<?php echo base_url('Receiving/delete/'.$data->id_brgmasuk);?>" onclick="return confirm('Yakin akan hapus data <?php echo $data->id_brgmasuk?> ?')">
