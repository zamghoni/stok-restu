...
<head>
  ...
  <title>Delivery | Stok Bengkel Restu</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="<?php echo base_url('Delivery')?>"><i class="fas fa-truck-loading"></i> <span>Barang Keluar</span></a></li>
              <?php
              }
              ?>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Edit Delivery</h2>

            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form role="form" action="<?php echo base_url('Delivery/edit/'.$delivery[0]->id_brgkeluar)?>" method="post">
                      <div class="form-group">
                        <label>No. Transaksi *</label>
                        <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $delivery[0]->id_brgkeluar?>" readonly>
                        <p><?php echo form_error('kode'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>Tgl. Transaksi *</label>
                        <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?php echo $delivery[0]->tgl_keluar?>">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="barang" id="barang">
                          ...
                          ?>
                          <option value="<?php echo $row->id_barang ?>" <?php echo $row->id_barang == $delivery[0]->id_barang ? 'selected' : "" ;?>><?php echo $row->nm_barang ; ?></option>
                          <?php } ?>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="jumlah" name="jumlah" value="<?php echo $delivery[0]->jml_keluar?>">
                        <p><?php echo form_error('jumlah'); ?></p>
                      </div>
                      <br>
                      <button type="submit" class="btn btn-primary">Simpan</button>
                      <a class="btn btn-secondary" href="<?php echo base_url('Delivery') ?>">Batal</a>
                    </form>
                </div>
              </div>
            </div>
