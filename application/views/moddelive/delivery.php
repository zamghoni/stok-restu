      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title"><a class="btn btn-outline-primary btn-sm" href="<?php echo base_url('Delivery/insert')?>"><i class="fa fa-plus"> Add Data</i></a></h2>
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                             ...
                             <td>
                              <a href="<?php echo base_url('Delivery/edit/'.$data->id_brgkeluar);?>">
                                <button type="button" class="btn btn-outline-success btn-rounded btn-sm"><i class="fa fa-edit"> Edit</i></button>
                              </a>
                              <a href="<?php echo base_url('Delivery/delete/'.$data->id_brgkeluar);?>" onclick="return confirm('Yakin akan hapus data <?php echo $data->id_brgkeluar?> ?')">
