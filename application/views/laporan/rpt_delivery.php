...
<head>
  ...
  <title>Report Delivery | Stok Bengkel Restu</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="<?php echo base_url('Rptdelivery')?>"><i class="fas fa-file-contract"></i> <span>Laporan Barang Keluar</span></a></li>
            ...
            <div class="row">
              ...
              <div class="col-lg-7" id="tanggalfilter">
                <div class="card">
                  ...
                  <form action="<?php echo base_url(); ?>Rptdelivery/filter" method="POST" target="_blank">
              ...
              <div class="col-lg-7" id="bulanfilter">
                <div class="card">
                  ...
                  <form id="formbulan" action="<?php echo base_url(); ?>Rptdelivery/filter" method="POST" target="_blank">
              ...
              <div class="col-lg-7" id="tahunfilter">
                <div class="card">
                  ...
                  <form id="formtahun" action="<?php echo base_url(); ?>Rptdelivery/filter" method="POST" target="_blank">
                    <input name="valnilai" type="hidden">
                    <div class="card-body">
