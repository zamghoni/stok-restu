...
<head>
  ...
  <title>Jenis | Stok Bengkel Restu</title>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a class="nav-link" href="<?php echo base_url('Jenis')?>">Jenis Barang</a></li>
              ...
              <li><a class="nav-link" href="<?php echo base_url('Rptreceiving')?>"><i class="fas fa-file-invoice"></i> <span>Barang Masuk</span></a></li>
              <li><a class="nav-link" href="<?php echo base_url('Rptdelivery')?>"><i class="fas fa-file-contract"></i> <span>Barang Keluar</span></a></li>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title"><a class="btn btn-outline-primary btn-sm" href="<?php echo base_url('Jenis/insert')?>"><i class="fa fa-plus"> Add Data</i></a></h2>
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $i ?></td>
                             ...
                             <td>
                              <a href="<?php echo base_url('Jenis/edit/'.$data->id_jenis);?>">
                                <button type="button" class="btn btn-outline-success btn-rounded btn-sm"><i class="fa fa-edit"> Edit</i></button>
                              </a>
                              <a href="<?php echo base_url('Jenis/delete/'.$data->id_jenis);?>" onclick="return confirm('Yakin akan hapus data <?php echo $data->nm_jenis?> ?')">
