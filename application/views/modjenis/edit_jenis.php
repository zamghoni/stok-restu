      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Tambah Jenis</h2>

            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form role="form" action="<?php echo base_url('Jenis/edit/'.$jenis[0]->id_jenis)?>" method="post">
                      <div class="form-group">
                        <label>Nama Jenis *</label>
                        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $jenis[0]->nm_jenis?>">
                        <p><?php echo form_error('nama'); ?></p>
                      </div>
                      <br>
                      <button type="submit" class="btn btn-primary">Simpan</button>
                      <a class="btn btn-secondary" href="<?php echo base_url('Jenis') ?>">Batal</a>
                    </form>
                </div>
              </div>
            </div>
