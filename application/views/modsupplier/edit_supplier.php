...
<head>
  ...
  <title>Supplier | Stok Bengkel Restu</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="<?php echo base_url('Supplier')?>"><i class="fas fa-city"></i> <span>Supplier</span></a></li>
              <?php
          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <form role="form" action="<?php echo base_url('Supplier/edit/'.$supplier[0]->id_supplier)?>" method="post">
                      <div class="form-group">
                        <label>Kode Supplier *</label>
                        <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $supplier[0]->id_supplier?>">
                        <p><?php echo form_error('kode'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>Nama Supplier *</label>
                        <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $supplier[0]->nm_supplier?>">
                        <p><?php echo form_error('nama'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>No. Telephone *</label>
                        <input type="number" class="form-control" id="telp" name="telp" value="<?php echo $supplier[0]->no_telp?>">
                        <p><?php echo form_error('telp'); ?></p>
                      </div>
                      <div class="form-group">
                        <label>Alamat *</label>
                        <textarea class="form-control" id="alamat" name="alamat" rows="3"><?php echo $supplier[0]->alamat?></textarea>
                        <p><?php echo form_error('alamat'); ?></p>
                      </div>
                      <br>
                      <button type="submit" class="btn btn-primary">Simpan</button>
                      <a class="btn btn-secondary" href="<?php echo base_url('Supplier') ?>">Batal</a>
                    </form>
                </div>
              </div>
            </div>
